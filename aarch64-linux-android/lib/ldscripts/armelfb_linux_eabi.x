...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/zefie/dev/toolchains/uber/out/aarch64-linux-android-8.x/aarch64-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
